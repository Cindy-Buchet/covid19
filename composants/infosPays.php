            ...
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row autres-donnees">
                            <p class="col-6"><?php if(isset($casCritique)){ echo $casCritique; } ?> <br/>cas critiques</p>
                            <p class="col-6"><?php if(isset($testEffectues)){ echo $testEffectues; } ?> <br/> tests effectuées</p>
                        </div>
                    </div>
                </div>
            </div>
